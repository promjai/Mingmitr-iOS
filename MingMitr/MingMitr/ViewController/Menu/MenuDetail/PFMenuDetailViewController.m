...
@interface PFMenuDetailViewController ()

@end

@implementation PFMenuDetailViewController
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    if ([self.navigationController.viewControllers indexOfObject:self] == NSNotFound) {
        ...
        if([self.delegate respondsToSelector:@selector(PFMenuDetailViewControllerBack)]){
            [self.delegate PFMenuDetailViewControllerBack];
        }
    }
}
